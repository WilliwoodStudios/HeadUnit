...
var $emulator = {
	...
	_extend: function() {
		...
		def = {
			/**
			 * Direction of a {@link $ui.WedgeTemperature} Screen 
			 * @namespace Direction
			 * @readonly
			 * @memberof $ui.WedgeTemperature
			 */
			Direction: {
				/** Appear from the left 
				* @memberof $ui.WedgeTemperature.Direction
				*/
				LEFT: 'left',
...
function emulator_HeadUnitChrome(object, data) {
	...
	if (object) {
		...
		*/
		...
		object.dom.volume.style.backgroundColor = $ui.theme.color;
...
function emulator_DefrostButton(object, screen) {
	...
	object.dom.style.backgroundColor = $ui.theme.color;
...
function emulator_HVACBar(object, screen) {
	...
	// Set our brand color
	object.dom.style.borderTopColor = $ui.theme.color;
...
function emulator_TemperatureButton(object, screen) {
	...
	object.dom.style.color = $ui.theme.color;
...
function emulator_NavigationBar(object, screen) {
	...
	// Set our brand color
	object.dom.style.borderRightColor = $ui.theme.color;
	object.dom.style.borderBottomColor = $ui.theme.color;
	
	// Add our clock
	object.dom.clock = document.createElement('div');
	$ui.addClass(object.dom.clock,'clock');
	object.dom.clock.style.color = $ui.theme.color;
	...
	object.dom.dot.style.backgroundColor = $ui.theme.color;
 ...
 * }
 * </pre>
 * @namespace WedgeTemperature
 * @memberof $ui
 * @extends $ui.CoreWedgeScreen
 * @property {number} temperature - The numeric temperature to show in the control
 * @property {$ui.WedgeTemperature.Direction} [direction=$ui.WedgeTemperature.Direction.LEFT] - The side in which the wedge should be displayed.
 * @property {TemperatureChangeEvent} [onchange] - This will fire when a user changes the temperature
 */
function emulator_WedgeTemperature(object, data) {
	...
	/** 
	* Set the temperature of the control
	* @function setTemperature
	* @memberof $ui.WedgeTemperature
	* @param {number} value - Numeric value in which to set the control
	*/
	object.setTemperature = function(value) {
...
/**
 * The {@link $ui.WedgeTemperature} <b>onchange</b> event will fire when the user interacts with a temperature button and changes the temperature
 * @callback TemperatureChangeEvent
 * @param {number} value - The value that was just set for the temperature
 */
