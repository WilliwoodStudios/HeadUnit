...
function artistList() {
    ...
    this.mostPlayedArtistsAvailable = function(topPlayed) {
        if (topPlayed && (topPlayed.length > 0)) {
            this.topPlayedProvider.data = {
                items: topPlayed
            };
    ...
    this.artistsAvailable = function(artists) {
    ...
    this.onshow = function() {
        ...
        if (mediaSource) {
            ...
            mediaSource.getMostPlayedArtists(this.mostPlayedArtistsAvailable);
            // Retrieve our list of all atrists
            mediaSource.getArtists(this.artistsAvailable);
        }
    };
}