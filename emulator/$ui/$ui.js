...
var $ui = {
	...
	init: function(object) {	
		...
		this.addExtension(new UIExtension('DockLayout', $ui_DockLayout, undefined, def));
		this.addExtension(new UIExtension('SegmentedControl', $ui_SegmentedControl));
		this.addExtension(new UIExtension('Tab', $ui_Tab));
		...
		this.addExtension(new UIExtension('Spinner', $ui_Spinner, undefined,def));
		this.addExtension(new UIExtension('TileGroup', $ui_TileGroup));
		def = {
			ProviderError: {
				OFFLINE: -1,
				INVALID_JSON: -2,
		...
		this.addExtension(new UIExtension('DataProvider', $ui_DataProvider, undefined, def));
		this.addExtension(new UIExtension('CircleMenu',$ui_CircleMenu));
		// Add our screen extensions
		this.addExtension(new UIExtension('WindowPane', $ui_WindowPane, $ui.UIExtensionType.SCREEN));
