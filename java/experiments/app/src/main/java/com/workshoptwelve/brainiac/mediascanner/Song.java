...
public class Song {
    ...
    private Song(Cursor c) {
        mUid = MediaHelper.getString(c, "uid");
        mName = MediaHelper.getString(c, "name");
        mDuration = MediaHelper.getLong(c, "duration", null);
        mTrackNumber = MediaHelper.getLong(c, "trackNumber", null);
        mAlbumUid = MediaHelper.getString(c, "albumUid");
        mPath = MediaHelper.getString(c, "path");
        mPlayCount = MediaHelper.getLong(c, "playCount", ZERO);
        mSkipCount = MediaHelper.getLong(c, "skipCount", ZERO);
        mRating = MediaHelper.getLong(c, "rating", ZERO);
    ...
    public Song(Album album, String name) {
        ...
        mUid = MediaHelper.createUID("song|" + mAlbumUid + "|" + mName);
    }
