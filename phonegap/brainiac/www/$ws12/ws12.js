/* ws12 VERSION: 1.0.0.15*/

var $ws12 = {
	// Initialize the toolkit extensions
	init: function() {
		// Add our control extensions
		$ui.addExtension({name:'Browser',definition:{},constructor:ws12_Browser});	
		$ui.addExtension({name:'DialPad',definition:{},constructor:ws12_DialPad});	
		$ui.addExtension({name:'Map',definition:{},constructor:ws12_Map});	
		$ui.addExtension({name:'MediaPlayer',definition:{},constructor:ws12_MediaPlayer});	
		// Custom Tiles
		$ui.addExtension({name:'TileAcceleration',definition:{},constructor:ws12_TileAcceleration});	
		$ui.addExtension({name:'TileBadge',definition:{},constructor:ws12_TileBadge});	
		$ui.addExtension({name:'TileBraking',definition:{},constructor:ws12_TileBraking});	
		$ui.addExtension({name:'TileDistance',definition:{},constructor:ws12_TileDistance});
		$ui.addExtension({name:'TileFuel',definition:{},constructor:ws12_TileFuel});
		$ui.addExtension({name:'TileIdle',definition:{},constructor:ws12_TileIdle});
		$ui.addExtension({name:'TileIdleDetails',definition:{},constructor:ws12_TileIdleDetails});
		$ui.addExtension({name:'TileMPG',definition:{},constructor:ws12_TileMPG});
		$ui.addExtension({name:'TileProfile',definition:{},constructor:ws12_TileProfile});
		$ui.addExtension({name:'TileRecord',definition:{},constructor:ws12_TileRecord});
		$ui.addExtension({name:'TileTimer',definition:{},constructor:ws12_TileTimer});
		$ui.addExtension({name:'TileWeeksActivity',definition:{},constructor:ws12_TileWeeksActivity});
		$ui.addExtension({name:'TileZeroToSixty',definition:{},constructor:ws12_TileZeroToSixty});
		$ui.addExtension({name:'TileZeroToSixtyHistory',definition:{},constructor:ws12_TileZeroToSixtyHistory});
		// Add our list item extensions
		$ui.addExtension({name:'PhoneLogListItem',definition:{ONCLICK: 'onclick',INCOMING: 'incoming',OUTGOING: 'outgoing',MISSED: 'missed'},type:$ui.ExtensionType.LISTITEM, constructor:ws12_PhoneLogListItem});
	}
}
